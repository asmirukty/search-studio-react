    ...
    return (
            <Accordion square expanded={expanded === `panel-${parentItem.id}`} onChange={handleChange(`panel-${parentItem.id}`)}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}
                    ...
                    <SearchCheckbox item={parentItem} itemName={parentItem.name} key={parentItem.id} pref checked={parents.includes(parentItem)}
                ...
                <AccordionDetails>
                    {
                        ...
                        <SearchCheckbox item={childItem} itemName={childItem.name} key={childItem.id} checked={children.includes(childItem)}
